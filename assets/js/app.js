...
function renderPostCard(p){
  ...
  const postCircle = circles.find(c => String(c.id) === String(p.circle));
  const groupBadgeInline = postCircle ? ` · <button class="post-group-badge" data-open-circle="${postCircle.id}">👥 ${escapeHtml(localText(postCircle, "bn", "en"))}</button>` : "";
