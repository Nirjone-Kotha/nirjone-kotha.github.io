...
const APP_SHELL = [
  ...
  "./assets/css/styles.css?v=6.2.0", "./assets/js/app.js?v=6.2.0", "./assets/js/data.js?v=6.2.0",
  "./assets/js/storage.js?v=6.2.0", "./assets/js/ads.js?v=6.2.0", "./assets/js/platform.js?v=6.2.0", "./assets/js/pwa.js?v=6.2.0", "./assets/js/safety.js?v=6.2.0",
  "./assets/js/config.js?v=6.2.0", "./assets/js/consent.js?v=6.2.0", "./assets/js/analytics.js?v=6.2.0", "./assets/js/public.js?v=6.2.0", "./assets/js/islamic.js?v=6.2.0", "./assets/js/video_catalog.js?v=6.2.0", "./assets/js/youtube_player.js?v=6.2.0",
  "./assets/js/firebase-core.js?v=6.2.0", "./assets/js/user-identity.js?v=6.2.0", "./admin/public/runtime-client.js?v=6.2.0",
  "./assets/css/admin_runtime.css?v=6.2.0", "./assets/css/public.css?v=6.2.0", "./config/site.json", "./config/firebase-config.js", "./config/firebase-defaults.js",
